...
-- 存储每一个已配置的Job的详细信息
CREATE TABLE JOB_CONFIG_DEFINE(
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `job_name` VARCHAR(120) NOT NULL,
  `label` VARCHAR(200) NOT NULL,
  `topic_type` VARCHAR(36) NOT NULL,
  `status` int(10) unsigned null default null comment '最近一次任务状态 0:待执行 1:执行中 2:执行成功 3:执行失败',
  `cron_expression` VARCHAR(250) NOT NULL,
  `data_map` text COLLATE utf8mb4_bin,
...
CREATE TABLE JOB_CONFIG_DEFINE_LOG(
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `job_id` bigint(20) NOT NULL,
  `topic_type` VARCHAR(36) NOT NULL,
  `status` int(10) unsigned null default null comment '流水状态 0:待执行 1:执行中 2:执行成功 3:执行失败',
  `cron_expression` VARCHAR(250) NOT NULL,
  `data_map` text COLLATE utf8mb4_bin,
